...
@media (max-width: 768px) {
  ...
  .stApp button[kind="headerNoPadding"][data-testid="stExpandSidebarButton"] {
  ...
  .stApp button[kind="headerNoPadding"][data-testid="stExpandSidebarButton"] svg { width: 22px !important; height: 22px !important; }
